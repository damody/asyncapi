...
/// [runtime expression](https://www.asyncapi.com/docs/specifications/v2.6.0#runtimeExpression)
/// is used.
...
pub struct CorrelationId {
    ...
    /// **REQUIRED**.
    /// A [runtime expression](https://www.asyncapi.com/docs/specifications/v2.6.0#runtimeExpression)
