...
pub struct AsyncAPI {
    ...
    pub asyncapi: String,
    /// Identifier of the
    /// [application](https://www.asyncapi.com/docs/specifications/v2.6.0#definitionsApplication)
    ...
    /// [contentType](https://www.asyncapi.com/docs/specifications/v2.6.0#messageObjectContentType)
    /// property is omitted.
    ///
